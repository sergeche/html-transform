 ...
 * stream that will stringified content of DOM. The DOM itself is available as
 * `.dom` property of Vinyl file.
 *
 * Module returns Transform stream, that can be attached to VinylFS reader:
 * `vfs.src('./*.xml').pipe(parseDOM())`
 */
'use strict';
...
/**
 * Reads file conyent from given Vinyl file
 * @param  {Vinyl} file
 * @return {Promise}
 */
